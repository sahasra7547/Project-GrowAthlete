...
Sports biomechanics, fatigue prediction, and athlete workload recommendation prototype built on top of MediaPipe pose tracking.

## Base MediaPipe Documentation
